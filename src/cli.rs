...
struct Cli {
    ...
    #[clap(long, multiple_values = true, value_delimiter = ',', value_name = "PATTERNS")]
...
pub fn run() -> Result<(), String> {
    ...
    if cli.exclude.is_some() && cli.include.is_some() {
    ...
    clone(fetch_gl, cli.dst, backup_gl, cli.include, cli.exclude)
}
